...
public class SmtpServerHandler extends SimpleChannelInboundHandler<String> {
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        this.smtpSession.Write("220 " + serverConfig.getHostname() + " ESMTP\r\n");
        channelGroup.add(channel);
        System.out.println(sdf.format(new java.util.Date())+":[SMTP客户端]" + channel.remoteAddress() + " 建立链接了----" +"当前链接数为:"+channelGroup.size());
    }
