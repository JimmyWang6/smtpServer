...
public class SmtpSession {
    private ServerConfig serverConfig = SpringContextHolder.getBean("serverConfig");
    ...
    public void Write(String str){
        log.info(sdf.format(new java.util.Date())+" -[SMTP服务器]发送: "+str.substring(0,str.length()-2));
