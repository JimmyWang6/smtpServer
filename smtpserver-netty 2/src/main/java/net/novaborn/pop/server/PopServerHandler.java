...
public class PopServerHandler extends SimpleChannelInboundHandler<String> {
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        this.popSession.Write("+OK " + serverConfig.getHostname()+ " POP3Server\r\n");
        channelGroup.add(channel);
        System.out.println(sdf.format(new java.util.Date())+":[POP客户端]" + channel.remoteAddress() + " 建立链接了----" +"当前链接数为:"+channelGroup.size());
    }
